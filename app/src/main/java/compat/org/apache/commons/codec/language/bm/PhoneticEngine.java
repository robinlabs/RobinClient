...
package compat.org.apache.commons.codec.language.bm;
...
public class PhoneticEngine {
    ...
    private static final class RulesApplication {
        ...
        /**
         * Invokes the rules. Loops over the rules list, stopping at the first one that has a matching packageName
