...
import com.magnifis.parking.BuildConfig;
...
public final class Settings {
    ...
    public static void publishInstallAsync(final Context context, final String applicationId) {
        // grab the application packageName ahead of time, since we will return to the caller immediately.
     ...
     * @param packageName the current Context
