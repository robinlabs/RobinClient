...
public class Request {
     ...
     * case the request is sent without an access token and thus is not executed in the packageName of any particular user.
     ...
     * provided, in which case the request is sent without an access token and thus is not executed in the packageName of
