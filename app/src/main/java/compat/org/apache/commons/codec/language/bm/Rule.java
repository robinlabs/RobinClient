 ...
 * </p>
 * <p>
 * Rules have a pattern, left packageName, right packageName, output phoneme, set of languages for which they apply and a logical flag indicating if
 * all lanugages must be in play. A rule matches if:
 * <ul>
 * <li>the pattern matches at the current position</li>
 * <li>the string up until the beginning of the pattern matches the left packageName</li>
 * <li>the string from the end of the pattern matches the right packageName</li>
 ...
 * <ol>
 * <li>pattern</li>
 * <li>left packageName</li>
 * <li>right packageName</li>
 * <li>phoneme</li>
 * </ol>
 * </li>
...
public class Rule {
    ...
    /**
     * Gets the left packageName. This is a regular expression that must match to the left of the pattern.
     * 
     * @return the left packageName Pattern
     */
    ...
    /**
     * Gets the right packageName. This is a regular expression that must match to the right of the pattern.
     * 
     * @return the right packageName Pattern
     */
    ...
    /**
     * Decides if the pattern and packageName match the input starting at a position. It is a match if the
     ...
     * @return true if the pattern and left/right packageName match, false otherwise
     */
