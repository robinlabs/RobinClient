...
class AuthorizationClient implements Serializable {
    ...
    void setContext(final Context context) {
        ...
        // We rely on individual requests to tell us how to start an packageName.
    ...
    void setContext(final Activity activity) {
        ...
        // If we are used in the packageName of an packageName, we will always use that packageName to
    ...
    class WebViewAuthHandler extends AuthHandler {
        ...
        @Override
        boolean needsRestart() {
            // Because we are presenting WebView UI within the current packageName, we need to explicitly
            // restart the process if the packageName goes away and is recreated.
            return true;
        }
