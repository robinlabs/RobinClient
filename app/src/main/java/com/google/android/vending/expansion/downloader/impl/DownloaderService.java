...
public abstract class DownloaderService extends CustomIntentService implements IDownloaderService {
    ...
    final static int ConnectivityManager_TYPE_ETHERNET=0x00000009,
    		ConnectivityManager_TYPE_BLUETOOTH=0x00000007,
    		ConnectivityManager_TYPE_WIMAX=0x00000006,
    	    TelephonyManager_NETWORK_TYPE_IDEN=0x0000000b,
    	    TelephonyManager_NETWORK_TYPE_LTE=0x0000000d,
    	    TelephonyManager_NETWORK_TYPE_EHRPD=0x0000000e,
    	    TelephonyManager_NETWORK_TYPE_HSPAP=0x0000000f
    ...
    private void updateNetworkType(int type, int subType) {
        switch (type) {
            ...
            case ConnectivityManager_TYPE_ETHERNET:
            case ConnectivityManager_TYPE_BLUETOOTH:
            ...
            case ConnectivityManager.TYPE_MOBILE:
                ...
                switch (subType) {
                    ...
                    case TelephonyManager.NETWORK_TYPE_UMTS:
                        ...
                        mIsAtLeast4G = false;
                        break;
                    case TelephonyManager_NETWORK_TYPE_LTE: // 4G
                    case TelephonyManager_NETWORK_TYPE_EHRPD: // 3G ++ interop
                                                              // with 4G
                    case TelephonyManager_NETWORK_TYPE_HSPAP: // 3G ++ but
                                                              // marketed as
                                                              // 4G
                        mIsAtLeast3G = true;
                        mIsAtLeast4G = true;
        ...
        public void run() {
            ...
            checker.checkAccess(new LicenseCheckerCallback() {
                ...
                public void dontAllow(int reason) {
                    try
                    {
                        if (mNotification!=null) switch ( reason ) {
     ...
     * there's no limit
     *
     * @param packageName the {@link Context} to use for accessing the {@link ContentResolver}
     * @return maximum size, in bytes, of downloads that may go over a mobile connection; or null if
     * there's no limit
     */
    public static long getMaxBytesOverMobile(Context context) {
        return 1024l*1024l*1024l;//DownloadManager.getMaxBytesOverMobile(packageName);
    }
    ...
    public static long getRecommendedMaxBytesOverMobile(Context context) {
        return 1024l*1024l*1024l;//DownloadManager.getRecommendedMaxBytesOverMobile(packageName);
    }
