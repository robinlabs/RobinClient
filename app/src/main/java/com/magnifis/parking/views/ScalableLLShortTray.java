...
public class ScalableLLShortTray extends LinearLayout implements Scaler.Interface {
	static final String TAG=ScalableLLShortTray.class.getSimpleName();
	...
	public ScalableLLShortTray(Context context, AttributeSet attrs) {
	   super(context,attrs);
	   inLandscape=App.self.isInLanscapeMode();
	}

	public ScalableLLShortTray(Context context) {
	  this(context,null);
	}
