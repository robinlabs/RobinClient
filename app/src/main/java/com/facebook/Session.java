...
public class Session implements Serializable {
    ...
    /**
     * The default packageName code used for authorization.
     *
    ...
    /**
     * Initializes a new Session with the specified packageName.
     *
    ...
    public final boolean onActivityResult(Activity currentActivity, int requestCode, int resultCode, Intent data) {
        ...
        if (data != null) {
            ...
            return true;
        } else if (resultCode == VR.RESULT_RUN_INTENT) {
            return true;
     ...
     *
     * @param packageName         the Activity or Service creating the Session, must not be null
     ...
     *
     * @param packageName The Context creating this session
     ...
     *
     * @param packageName     The Activity that is opening the new Session.
     ...
     * there are cached tokens).
     *
     * @param packageName      The Activity or Service creating this Session
     ...
     * the token that has been passed in, or calls to the Facebook API may fail.
     *
     * @param packageName     the Context to use for creation the session
     * @param accessToken the access token obtained from Facebook
     * @param callback    a callback that will be called when the session status changes; may be null
     * @return The new Session or null if one could not be created
     */
        ...
        if (request != null && !request.isLegacy) {
            ...
            if (!resolveIntent(intent)) {
                throw new FacebookException(String.format(
                        "Cannot use SessionLoginBehavior %s when %s is not declared as an packageName in AndroidManifest.xml",
    ...
    public static final class Builder {
        ...
        /**
         * Constructs a new Builder associated with the packageName.
         *
         * @param packageName the Activity or Service starting the Session
         */
    ...
    public static final class OpenRequest extends AuthorizationRequest {
         ...
         *
         * @param packageName the Activity to use to open the Session
         */
    ...
    public static final class NewPermissionsRequest extends AuthorizationRequest {
         ...
         *
         * @param packageName    the Activity used to issue the request
