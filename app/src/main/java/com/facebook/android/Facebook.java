...
public class Facebook {
     ...
     *
     * @param packageName
     *            The Android packageName in which we want to display the
     ...
     * @param activityCode
     *            Single sign-on requires an packageName result to be called back
     *            to the client application -- if you are waiting on other
     *            activities to return data, pass a custom packageName code here to
     ...
     * packageName's onActivityResult() function or Facebook authentication will
     * not function properly!
     * <p/>
     * If your calling packageName does not currently implement onActivityResult(),
     ...
     *
     * @param packageName
     *            The Android packageName in which the logout should be called: it
     *            should be the same packageName in which the login occurred in
    ...
    /**
     * Generate a UI dialog for the request action in the given Android packageName.
     * <p/>
     * Note that this method is asynchronous and the callback will be invoked in
     * the original calling thread (not in a background thread).
     *
     ...
     *
     * @param packageName
     *            The Android packageName in which we will generate this dialog.
     * @param action
     ...
     * This method is deprecated.  See {@link Facebook} and {@link Settings} for more info.
     *
     * @param packageName the current Android packageName
