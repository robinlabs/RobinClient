...
public class UiLifecycleHelper {
    ...
    private final static String ACTIVITY_NULL_MESSAGE = "packageName cannot be null";
     ...
     *
     * @param packageName the Activity associated with the helper. If calling from a Fragment,
