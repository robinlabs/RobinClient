...
public class LicenseChecker implements ServiceConnection {
    ...
    private class ResultListener extends ILicenseResultListener.Stub {
        ...
        public void verifyLicense(final int rspCode, final String signedData,
                final String signature) {
            mHandler.post(new Runnable() {
                public void run() {
                	int responseCode=rspCode;
                    ...
                    if (mChecksInProgress.contains(mValidator)) {
                        clearTimeout();
                        //{ // zeev belkin
                        if (signedData==null) responseCode=LicenseValidator.ERROR_NOT_MARKET_MANAGED;
                        //}
    ...
    /**
     * Inform the library that the packageName is about to be destroyed, so that any
