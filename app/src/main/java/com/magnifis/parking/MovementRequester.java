 ...
 *
 */
public class MovementRequester
    ...
    private void continueRequestActivityUpdates() {
         ...
         * The PendingIntent sends updates to MovementService
         */
        getActivityRecognitionClient().requestActivityUpdates(
        		MovementService.DETECTION_INTERVAL_MILLISECONDS,
    ...
    private PendingIntent createRequestPendingIntent() {
        ...
        // If no PendingIntent exists
            ...
            Intent intent = new Intent(mContext, MovementService.class);
            
            //Intent intent = new Intent(MovementService.ApplicationMonitorAction.NOTIFY.name(), 
  				//		null, App.self, MovementService.class);            
    ...
    public void onConnectionFailed(ConnectionResult connectionResult) {
        ...
        try {
            //connectionResult.startResolutionForResult(mContext,
            		//MovementService.CONNECTION_FAILURE_RESOLUTION_REQUEST);
